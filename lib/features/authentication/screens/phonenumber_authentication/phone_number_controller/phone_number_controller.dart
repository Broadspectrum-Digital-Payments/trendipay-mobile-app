  ...
  otpVerify() async {
    ...
    try {
      ...
      if(apiResponse.allGood!) {
        ...
        await GlobalConstants.storageService.setString(GeneralRepository.phoneMedium, medium);
        await GlobalConstants.storageService.setString(GeneralRepository.resourceId, resourceId);
